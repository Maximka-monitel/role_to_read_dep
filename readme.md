...
2025-08-06 09:01:35 [INFO]: Строка 4: Добавляется роль: Чтение записей под подр-ю {org_name}\{headdep_name}\{dep_name}, режим рекурсивного поиска =True, headdep_uid=8383B7DD-AAAD-4F10-ADEF-D50FD7974D9D (только своё подразделение)
