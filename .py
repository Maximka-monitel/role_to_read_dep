...
with open('dep_sample.csv', encoding='utf-8') as csvfile:
...
with open("cim_generated_multi.xml", "wb") as f:
    f.write(xml_bytes)

print("Готово! RDF XML для множества ролей сохранён как cim_generated_multi.xml")
